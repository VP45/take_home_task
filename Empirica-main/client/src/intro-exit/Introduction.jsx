  ...
  return (
    <div style={sectionStyle}>
      <div style={headingContainerStyle}>
        ...
        />
        <h1 className="text-lg mt-20 leading-6 font-bold font-large text-gray-900" style={headingTextStyle}>
      ...
      <Button handleClick={next} className="py-1 px-2 mt-2" style={buttonStyle} autoFocus>
        <p>Next &nbsp; ➜</p>
      </Button>
    </div>
  );
